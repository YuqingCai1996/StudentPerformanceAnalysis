...
raw_StudentsPerformance <- read.csv(".../data_raw/raw_StudentsPerformance.csv")
...
write_csv(summary_data, ".../data_clean/clean_StudentsPerformance.csv")
...
write_csv(summary_data_prep_course, ".../data_clean/clean_StudentsPerformance_prep_course.csv")
...
write_csv(summary_data_lunch, ".../data_clean/clean_StudentsPerformance_lunch.csv")
